...
<template>
  <div class="w-[350px] h-full bg-white dark:bg-gray-800 shadow-lg flex flex-col border-r border-gray-200 dark:border-gray-700 z-10">
    <!-- Header -->
    <div class="p-4 border-b border-gray-200 dark:border-gray-700 bg-blue-600 dark:bg-gray-800">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-xl font-bold text-white">PG Food Map</h1>
          <p class="text-sm text-blue-100 dark:text-gray-400">Prince George Restaurant Inspections</p>
        </div>
        <!-- Dark mode toggle -->
        <button
          @click="emit('toggle-dark-mode')"
          class="p-2 rounded-lg bg-blue-700 dark:bg-gray-700 hover:bg-blue-800 dark:hover:bg-gray-600 transition-colors"
