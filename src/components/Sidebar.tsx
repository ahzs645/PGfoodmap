...
export function Sidebar({
  ...
  return (
    <div className="w-[350px] h-full bg-white dark:bg-gray-800 shadow-lg flex flex-col border-r border-gray-200 dark:border-gray-700 z-10">
        ...
        <div className="p-4 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            <div className="bg-white dark:bg-gray-800 p-2 rounded shadow-sm">
              <div className="text-2xl font-bold text-red-600">{timelineStats?.totalViolations || 0}</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Total Violations</div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-2 rounded shadow-sm">
              <div className="text-2xl font-bold text-orange-600">{timelineStats?.criticalViolations || 0}</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Critical</div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-2 rounded shadow-sm">
              <div className="text-2xl font-bold text-blue-600">{timelineStats?.totalInspections || 0}</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Inspections</div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-2 rounded shadow-sm">
              <div className="text-2xl font-bold text-gray-700 dark:text-gray-300">{timelineStats?.restaurantsWithViolations || 0}</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">With Violations</div>
            </div>
          </div>
        </div>
      ) : (
        <div className="p-4 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
          <div className="text-xs text-gray-500 dark:text-gray-400 mb-2">At Selected Date</div>
          <div className="grid grid-cols-3 gap-2 text-sm">
            <div className="bg-white dark:bg-gray-800 p-2 rounded shadow-sm text-center">
              <div className="text-xl font-bold text-green-600">{hazardStatsAtDate?.Low || 0}</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Low</div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-2 rounded shadow-sm text-center">
              <div className="text-xl font-bold text-amber-600">{hazardStatsAtDate?.Moderate || 0}</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Moderate</div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-2 rounded shadow-sm text-center">
              <div className="text-xl font-bold text-gray-600">{hazardStatsAtDate?.Unknown || 0}</div>
      ...
      {/* Map count */}
      <div className="px-4 py-2 text-xs text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
